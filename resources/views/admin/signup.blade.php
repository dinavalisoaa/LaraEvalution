...
<body>
    ...
    <div class="container py-5 h-100">
        ...
        <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
            <form action="{{ route('a_actionSign')}}" class="box form-prevent-multiple-submits" method="get">
            <div class="form-outline mb-4">
            <label class="form-label" for="form1Example13">NOM</label>
         <input type="text" id="form1Example13" name="nom" class="form-control form-control-lg" >                </div>   
            <div class="form-outline mb-4">
            ...
            <input type="email" id="form1Example13" name="email" class="form-control form-control-lg" required/>
                ...
                <div class="d-flex justify-content-around align-items-center mb-4">
                  ...
                  <a href="{{ route('actionLog')}}">ROUTE</a>
                    <a href="<?php echo url('traite/inscription'); ?>"> Sign up for Fen-UP</a>
                </div>
